...
var deutschland = {
    ...
    references: {
        ...
        reference2: {
            name: "Alianz Arena",
            volumen: 2928300,
            image_link: "./images/alianzarena.jpg",
...
var italien = {
    ...
    references: {
        ...
        reference2: {
            name: "Kolosseum",
            volumen: 1105632,
            image_link: "./images/kolosseum.jpg",
...
var sparpotential = {
    item1: { // <100 CHF
        ...
        image_link: "./images/img_slider/taschengeld.jpg"
    },
    item2: { // 101 - 300 CHF
        min: 101,
        max: 300,
        ...
        image_link: "./images/img_slider/einkaufswagen.jpg",
    },
    item3: { // 301 - 500 CHF
        min: 301,
        max: 500,
    ...
    item6: { // > 901 CHF
        ...
        image_link: "./images/img_slider/karibik.jpeg"
    }
};