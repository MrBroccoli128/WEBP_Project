$(function () {
  ...
  */
  $('.reference').click(function () {
    ...
    $('#text_reference_rel').text(" Der Food Waste von " + eval(countyselect).countryname + " passt somit " + calcrelation(eval(countyselect).foodwastequantity, eval(countyselect)["references"][this.id]["volumen"]) + " mal in den/die " + eval(countyselect)["references"][this.id]["name"] + ".");
